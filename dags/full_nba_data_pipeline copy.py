...
start_telegram_bot = PythonOperator(
    task_id='start_bot',
    python_callable=start_bot,
)


# Corrected dependencies for bot activation
[spark_kafka_to_postgres_teams, spark_kafka_to_postgres_players, spark_kafka_to_postgres_games] >> start_telegram_bot